...
urlpatterns = [
    ...
    path('rescuerclick', views.mechanicsclick_view),

    path('customersignup', views.customer_signup_view,name='customersignup'),
    path('rescuersignup', views.mechanic_signup_view,name='rescuersignup'),

    path('customerlogin', LoginView.as_view(template_name='vehicle/customerlogin.html'),name='customerlogin'),
    path('rescuerlogin', LoginView.as_view(template_name='vehicle/rescuerlogin.html'),name='rescuerlogin'),
    ...
    path('admin-rescuer', views.admin_mechanic_view,name='admin-rescuer'),
    path('admin-view-rescuer',views.admin_view_mechanic_view,name='admin-view-rescuer'),
    ...
    path('admin-add-rescuer',views.admin_add_mechanic_view,name='admin-add-rescuer'),
    path('admin-approve-rescuer',views.admin_approve_mechanic_view,name='admin-approve-rescuer'),
    path('approve-rescuer/<int:pk>', views.approve_mechanic_view,name='approve-rescuer'),
    path('delete-mechanic/<int:pk>', views.delete_mechanic_view,name='delete-mechanic'),
    path('admin-view-rescuer-salary',views.admin_view_mechanic_salary_view,name='admin-view-rescuer-salary'),
    path('update-salary/<int:pk>', views.update_salary_view,name='update-salary'),

    path('admin-rescuer-attendance', views.admin_mechanic_attendance_view,name='admin-rescuer-attendance'),
    ...
    path('rescuer-dashboard', views.mechanic_dashboard_view,name='rescuer-dashboard'),
    path('rescuer-work-assigned', views.mechanic_work_assigned_view,name='rescuer-work-assigned'),
    path('mechanic-update-status/<int:pk>', views.mechanic_update_status_view,name='mechanic-update-status'),
    path('rescuer-feedback', views.mechanic_feedback_view,name='rescuer-feedback'),
    path('rescuer-salary', views.mechanic_salary_view,name='rescuer-salary'),
    path('rescuer-profile', views.mechanic_profile_view,name='rescuer-profile'),
    path('edit-rescuer-profile', views.edit_mechanic_profile_view,name='edit-rescuer-profile'),

    path('rescuer-attendance', views.mechanic_attendance_view,name='rescuer-attendance'),
