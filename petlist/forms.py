...
class RequestForm(forms.ModelForm):
    class Meta:
        ...
        fields=['category','animal_no','location','envi','character','problem_description']
        widgets = {
...
class AdminRequestForm(forms.Form):
    ...
    mechanic=forms.ModelChoiceField(queryset=models.Mechanic.objects.all(),empty_label="Rescuer Name",to_field_name='id')
...
class MechanicUpdateStatusForm(forms.Form):
    stat=(('Approved','Approved'),('Rescuing/Turnin','Rescuing/Turnin'),('Work Done','Work Done'))
    status=forms.ChoiceField( choices=stat)
